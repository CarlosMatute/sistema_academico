    ...
    <div class="col-12 col-md-12 col-xl-12">
        <div class="alert alert-dark bg-azul-claro" role="alert">
            <h4 class="display-4 d-flex align-items-center">
                <i data-feather="book" class="me-3" style="width: 45px; height: 45px;"></i>
                <strong>ASIGNATURAS</strong>
            </h4>
            <h5 class="lead bg-white"><div class="alert alert-fill-white" role="alert">Módulo de administracion de asignaturas.</div></h5>
            <br />
            <div class="col-md-3">
        ...
        <div class="col-12 col-md-12 col-xl-12">
            <div class="card border-secondary">
                <h5 class="card-header bg-azul text-white d-flex justify-content-between align-items-center">
                    <span class="text-white"> <i class="text-white icon-lg pb-3px" data-feather="list"></i> Asignaturas </span>
...
@push('custom-scripts')
  ...
  <script type="text/javascript">
    ...
    var id_seleccionar = localStorage.getItem("tbl_asignaturas_id_seleccionar");
    $(document).ready(function () {
        ...
        table = $("#tbl_asignaturas").DataTable({
            aLengthMenu: [
                [10, 30, 50, 100, -1],
                [10, 30, 50, 100, "Todo"],
            ],
        ...
        $("#tbl_asignaturas tbody").on("click", ".btn_editar", function () {
            //alert('Hey');
            accion = 2;
        });

        $("#tbl_asignaturas").each(function () {
            var datatable = $(this);
        ...
        $("#tbl_asignaturas tbody").on("click", "tr", function () {
            rowNumber = parseInt(table.row(this).index());
            table.$("tr.selected").removeClass("selected");
            $(this).addClass("selected");
            localStorage.setItem("tbl_asignaturas_id_seleccionar", table.row(this).data()[0]);
        });
